...
public class SpawnManager : MonoBehaviourPunCallbacks
{
    ...
    {
        object playerSelectionNumber;
        PhotonNetwork.LocalPlayer.CustomProperties.TryGetValue(MultiplayerSpinnerTopGame.PLAYER_SELECTION_NUMBER, out playerSelectionNumber);
        Debug.Log(playerSelectionNumber.ToString());
